...
**On Uncertainty**. If we are doing anything new, then there is going to be fundamental uncertainty. I am comfortable making decisions based on intuition despite uncertainty, but I still like to increase my chances. I prefer decisions based on data, when data can be practically obtained.  I want to learn whatever is easy to learn, and have a plan about all the stuff that’s hard to learn. How and when to learn it, or where to find an expert. I’d like to try to map out our unknown unknowns, perhaps with some external advice. And when we can’t make decisions based on data, I’d like to check if our intuition is at least based on experience. 
