...
- I can get frustrated when a meeting is derailed, am known to try to take the wheel to get it back on track. 
...
# Introspections
**On engineering**. Not only am I an engineer by training, but I’ve been disassembling and building things since I was a kid. I view nearly everything through an engineering-tinted lens, but I’m not just interested in machines and code. When all you have is a hammer, everything looks like a nail. To me,  accounting, marketing, recruiting, org design and politics all look like process problems. At least, that’s where I tend to start.
...
**On problem solving**. I work through every-day problems like a computer programmer and think with jargon that is lifted straight out of my education. Ideas get arranged on orthogonal axes, and work gets optimised with short-circuit evaluation and binary searches. If you want to take a closer peek inside my interior monologue I tried to blog some of it [here](/2023/07/inner-problem-solving-jargon). 


**On Uncertainty**. When doing something new, there will be a need to make fast decisions despite fundamental uncertainty. I am comfortable with this, but I still like to increase my chances. I prefer decisions based on data, when data can be practically obtained.  I want to learn whatever is easy to learn, and have a plan about the remainder. How and when to learn it, or where to find an expert. I’d like to try to scope out my unknown unknowns, perhaps with some external advice. When we can’t make decisions based on data, I’d like to check if my intuition is at least based on experience. When there is neither data nor reliable intuition, I try to make the least catastrophic guesses.


**On Energy**. One of my most popular blog posts is [The Energon Methodology](https://seanblanchfield.com/2011/07/the-energon-methodology) (inspired by the 1980s Transformer cartoon, or the Michael Bay movies if you prefer), in which I set out a basic method of accounting for mental energy expended during a day. Hard thinking requires emotional as well as intellectual fortitude, and many days don’t work out as planned because something comes along and steals all your "energons". For me, giving people my full attention is both rewarding but very costly in terms of energons. If I spend a morning consulting, teaching or being an attentive soundboard, I probably won’t spend the afternoon coding. The most expensive energon loss comes from stressful conflict, whether in work, at home or in transport between the two. I have found it’s important not only to know how to be calm when someone else isn’t, but more structurally to avoid spending time with people who cause conflict.
...
- [Accounting for non-accounting students](https://www.amazon.co.uk/Accounting-Non-Accounting-Students-John-Dyson/dp/0273722972) <br />
You can't avoid accounting and bookkeeping. If you're going to be an entrepreneur, it's will be a big part of your life. The best strategy is learn it soon and well so you can use it as a tool to properly manage your business, not just stay compliant. This is the book I used.
- [Getting To Yes](https://en.wikipedia.org/wiki/Getting_to_Yes) <br />
The book that coined BATNA and ZOPA, and showed us that negotiations shouldn't be zero-sum games. Being an agreeable sort of person, I used to dread negotiations, and would often avoid them entirely (and probably missed lots of opportunities as a result). I also witnessed pitbull negotiators irrevokably wreck working relationships in an attempt to "win". This book provided me with a principled and comprehensive framework to calmly approach any negotiation with, with the aim of a mutually agreeable outcome. This has been useful in both business and life.