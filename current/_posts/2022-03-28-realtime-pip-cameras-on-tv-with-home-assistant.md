...
I could then add WebRTC camera cards to my UI by adding a "manual" card like this (where "PASSWORD" is redacted AND "CAMERA IP" represents the local camera IP address):
...
Make sure you have enabled developer options on your Android TV, and know what the IP address of your Android TV is (instructions are given on Stackoverflow [here](https://stackoverflow.com/questions/31421872/adb-connection-to-an-androidtv#:~:text=You%20need%20to%20use%20ADB,are%20now%20a%20developer%22%20appears.)).
