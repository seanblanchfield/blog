...
{: .callout }
> **Update, June 2023**. Things have moved on since I initially wrote this post. In particular, *go2rtc* was launched, which I now use instead of either of the *WebRTC Camera* or *RTSPtoWeb* options I discuss below. I have therefore rewritten this guide, and I recommend you [head over to the new version](/2023/06/realtime-pip-cameras-on-tv-with-home-assistant-v2) instead.
